...
public class Entity {
    ...
    public GamePanel gp;
    public BufferedImage up1, up2, down1, down2, left1, left2, right1, right2, avt;
    ...
    public String knocBackDirection;
    ...
    public void setKnockBack(Entity target, Entity attacker, int knockBackPower){
        ...
        target.knocBackDirection = attacker.direction;
    ...
    public BufferedImage setup(String imagePath, int width, int height){
        ...
        try {
            ...
            // System.out.println("loadImage " + imagePath + " success!");
        } catch (IOException e) {
            e.printStackTrace();
        }
        return image;
