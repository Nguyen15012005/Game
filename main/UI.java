...
public class UI {
    ...
    GamePanel gp;
    Graphics2D g2;
    public Font maraMonica;
    public Font purinaBold;
    ...
    public UI(GamePanel gp) {
        this.gp = gp;
        try {
            InputStream is = getClass().getResourceAsStream("/font/MaraMonica.ttf");
            maraMonica = Font.createFont(Font.TRUETYPE_FONT, is);
            is = getClass().getResourceAsStream("/font/Purina_Bold.ttf");
            purinaBold = Font.createFont(Font.TRUETYPE_FONT, is);
            is.close();
    ...
    public void draw(Graphics2D g2) {
        ...
        g2.setFont(maraMonica);
        g2.setFont(purinaBold);
    ...
    public void drawTitleScreen(){
        ...
        if (titleScreenState == 0){
            ...
            y += gp.tileSize*2;
            g2.drawImage(gp.player.avt, x, y, gp.tileSize*3, gp.tileSize*3, null);
    ...
    public void drawCharacterScreen(){
        ...
        g2.drawString("Coin", textX, textY);textY += lineHeight + 40;
        g2.drawString("Weapon", textX, textY);textY += lineHeight + 30;
    ...
    public void trade_buy(){
        ...
        if (itemIndex < npc.inventory.size()){
            ...
            height = gp.tileSize;
            drawSubWindow(x, y, width, height);
            g2.drawImage(coin, x+10, y+8, 45, 45, null);
